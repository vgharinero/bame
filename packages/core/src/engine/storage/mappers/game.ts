...
import type { JsonValue, Payload, PayloadMap } from '../../primitives';
	...
	>(
		...
		return {
			gameRecord: {
				...
				status: game.status,
				config: game.config as JsonValue,
				seed: game.seed,
				publicState: game.publicState as JsonValue,
				currentTurn: game.turn as JsonValue,
