...
program
    ...
    .action(async (options) => {
        ...
        console.log("🎮 Initializing bame project...\n");
        ...
        if (!options.skipPages) {
            const pages = [
                { src: "app/signin/page.tsx.template", dest: "app/signin/page.tsx" },
                { src: "app/signup/page.tsx.template", dest: "app/signup/page.tsx" },
                { src: "app/lobby/page.tsx.template", dest: "app/lobby/page.tsx" },
                { src: "app/game/[id]/page.tsx.template", dest: "app/game/[id]/page.tsx" },
            ];
        ...
        const gameDefSource = join(TEMPLATES_DIR, "lib", "game-definition.ts.template");
        ...
        console.log("   4. Install dependencies: pnpm add @bame/core @bame/next-supabase");
    });
